...
/// {@template amplify_common.event}
/// Base class for discrete events of a state machine.
/// {@endtemplate}
@immutable
abstract class StateMachineEvent<EventType extends Enum>
    with AWSEquatable<StateMachineEvent<EventType>> {
  /// {@macro amplify_common.event}
...
mixin ErrorEvent<EventType extends Enum> on StateMachineEvent<EventType> {
  /// The exception which triggered this event.
  Exception get exception;

  @override
  String toString() => '$type ($exception)';
}
